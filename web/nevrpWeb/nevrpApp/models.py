...
class Node(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('node-detail', kwargs={'pk': self.pk, 'slug': self.slug})
...
class Order(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('order-detail', kwargs={'pk': self.pk, 'slug': self.slug})
    ...
    def __str__(self):
        return '%s - %s' %(self.code, self.create_at)
...
class Vehicle(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('vehicle-detail', kwargs={'pk': self.pk, 'slug': self.slug})
