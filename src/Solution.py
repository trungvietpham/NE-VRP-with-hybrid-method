...
class Solution:
    ...
    def find_solution(self):
        ...
        prepare_phase = PrepareData(r'data\vehicles.csv', r'data\node.csv', r'data\correlations.csv', r'data\order_sample.csv')
        ...
        main_order_controller = Phase2(all_data[1], main_order_controller, support_order_controller, all_data[3], all_data[4]).execute(all_data[0][encode[-1]], all_data[0][encode[-1]], f'scenarios/output_sender_receiver.{encode[-1]}-{encode[-1]}.json')
